...
>    refuses too. **There is NO override flag.** A breaker stuck open is cleared at the breaker
>    itself — the state this reads — never by teaching the probe to ignore it.
