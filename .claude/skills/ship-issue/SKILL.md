...
4. PR: Conventional-Commit title (`feat(scope): …`), body links the issue, tests included — ≥80% patch coverage (Codecov). Commits end with the Claude co-author trailer.
...
Authoritative: `docs/AGENT_WORKFLOW_PLAYBOOK.md` (labels, Decision Comments, phased issues), `CONTRIBUTING.md` (commit/PR conventions).
