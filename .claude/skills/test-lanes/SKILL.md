...
6. Test the pure half of Selenium code (parsing, scoring, message shaping) in unit tests; DOM interaction belongs in e2e or the live probe (see the linkedin-live-validation skill).
