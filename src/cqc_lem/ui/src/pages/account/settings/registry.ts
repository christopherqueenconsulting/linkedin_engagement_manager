...
export const SETTINGS: SettingDescriptor[] = [
  ...
  D({ key: 'hold_repaired_posts_for_review', section: 'content', label: 'Hold repaired drafts for review',
    ...
    why: 'The checks passing on the second attempt is exactly the post nobody has read — the first draft was similar, generic or invented something.',
    recommended: 'On. Turn it off only once repaired drafts routinely read the way you would have written them.' }),
  ...
  D({ key: 'min_connection_icp_score', section: 'outreach', label: 'Min. ICP fit score', advanced: true,
    ...
    recommended: '55.' }),
  D({ key: 'profile_viewer_dm_auto_send', section: 'outreach', label: 'Send profile-viewer outreach without approval',
    what: 'Whether someone who viewed your profile is messaged (or invited) straight away, instead of waiting in your approval queue.',
    why: 'This is the coldest thing LEM does — the person has not engaged with you, only looked. Off, each one becomes a draft you approve; on, it goes out unseen.',
    recommended: 'Off. Turn it on once the drafts you approve are consistently ones you would have sent anyway.' }),
