...
- [PostHog PR takeover](posthog-pr-takeover.md) — PostHog self-driving PRs become our issue + branch + PR, so `lem-agentd` iterates instead of PostHog's billed agent
