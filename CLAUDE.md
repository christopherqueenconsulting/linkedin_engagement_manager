...
| **Newsletter covers + publish gate** (#893, #1432, #1135) | `_approved_cover_path`; `get_editions_due_to_publish` | A **generated** cover lands `pending_review`, and an unapproved one at the slot is notify-and-publish. A `draft` edition ships only under `auto_publish_newsletters` | `docs/newsletter-covers.md` |
