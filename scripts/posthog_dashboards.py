...
Env:
  POSTHOG_OPERATOR_API_KEY   Personal API key with insight:write + dashboard:write (required for
                             network), falling back to POSTHOG_PERSONAL_API_KEY (posthog_keys.py
                             owns the precedence).
