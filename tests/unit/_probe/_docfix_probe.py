...
def probe_line_too_long():
    """Return a string whose literal is deliberately past the 120-character line-length limit so the ruff E501 rule fires here."""
    return "this line is deliberately far too long for the configured ruff line-length limit of one hundred and twenty characters"
