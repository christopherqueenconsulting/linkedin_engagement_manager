...
class TestInviteNoteGate:
    ...
    def test_a_refused_note_never_reaches_the_composer(self, note):
    ...
    @pytest.mark.parametrize("note", [INCIDENT_NOTE, PLACEHOLDER_NOTE])
    def test_the_invite_itself_is_not_abandoned(self, note):
    ...
    def test_the_refusal_names_the_checks_that_fired(self):
    ...
    def test_a_clean_note_still_reaches_the_composer(self):
    ...
    def test_no_note_at_all_is_unchanged(self):
