...
class TestGetPostsForEmail:
    ...
    def test_returns_200_with_posts(self, api_client, signed_in):
    ...
    def test_pagination_params_forwarded(self, api_client, signed_in):
    ...
    def test_sort_order_desc(self, api_client, signed_in):
        with patch(f"{_DB}.get_posts", return_value=([], 0)) as mock_get:
            resp = api_client.get(
                "/api/posts/",
    ...
    def test_status_filter_forwarded(self, api_client, signed_in):
    ...
    def test_post_type_and_search_and_sort_by_forwarded(self, api_client, signed_in):
        with patch(f"{_DB}.get_posts", return_value=([], 0)) as mock_get:
            resp = api_client.get(
                "/api/posts/",
                params={
    ...
    def test_invalid_post_type_filter_422(self, api_client, signed_in):
        resp = api_client.get(
            "/api/posts/",
    ...
    def test_invalid_sort_by_422(self, api_client, signed_in):
        resp = api_client.get(
            "/api/posts/",
    ...
    def test_carousel_slides_json_string_parsed(self, api_client, signed_in):
    ...
    def test_empty_posts_list_returns_200(self, api_client, signed_in):
    ...
    def test_date_range_params_forwarded(self, api_client, signed_in):
        with patch(f"{_DB}.get_posts", return_value=([], 0)) as mock_get:
            resp = api_client.get(
                "/api/posts/",
                params={
    ...
    def test_malformed_start_date_returns_422(self, api_client, signed_in):
        resp = api_client.get(
            "/api/posts/",
...
class TestBulkUpdatePostsEndpoint:
    ...
    def test_returns_200_on_success(self, api_client, signed_in):
    ...
    def test_empty_post_ids_returns_400(self, api_client, signed_in):
        resp = api_client.post(
            "/api/posts/bulk_update/",
    ...
    def test_bulk_update_failure_returns_405(self, api_client, signed_in):
    ...
    def test_status_only_update(self, api_client, signed_in):
    ...
    def test_scheduled_datetime_update(self, api_client, signed_in):
        with patch(f"{_DB}.bulk_update_posts", return_value=True) as mock_update:
            resp = api_client.post(
                "/api/posts/bulk_update/",
...
class TestDeletePostsEndpoint:
    ...
    def test_soft_delete_failure_returns_405(self, api_client, signed_in):
    ...
    def test_calls_soft_delete_with_correct_ids(self, api_client, signed_in):
    ...
    def test_passes_rejection_reason_to_soft_delete(self, api_client, signed_in):
        with patch(f"{_DB}.soft_delete_posts", return_value=True) as mock_delete:
            resp = api_client.request(
                "DELETE",
                "/api/posts/",
    ...
    def test_blank_rejection_reason_becomes_none(self, api_client, signed_in):
        with patch(f"{_DB}.soft_delete_posts", return_value=True) as mock_delete:
            api_client.request(
                "DELETE",
                "/api/posts/",
    ...
    def test_rejection_reason_too_long_returns_422(self, api_client, signed_in):
        resp = api_client.request(
            "DELETE",
            "/api/posts/",
...
class TestUpdatePost:
    ...
    def test_update_failure_returns_405(self, api_client, signed_in):
    ...
    def test_missing_post_id_returns_422(self, api_client, signed_in):
        ...
        with patch(f"{_DB}.update_db_post", return_value=True):
            resp = api_client.post("/api/update_post/", json=_POST_BODY)
        assert resp.status_code == 422

    def test_calls_update_db_post_with_correct_args(self, api_client, signed_in):
    ...
    def test_with_video_url(self, api_client, signed_in):
    ...
    def test_rejection_reason_persisted_on_update(self, api_client, signed_in):
    ...
    def test_blank_rejection_reason_not_persisted(self, api_client, signed_in):
