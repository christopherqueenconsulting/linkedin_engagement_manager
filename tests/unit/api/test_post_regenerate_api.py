...
class TestRegeneratePostEndpoint:
    def test_dispatches_task_with_guidance(self, api_client):
        with patch("cqc_lem.api.main.get_session_user_id", return_value=_USER), \
            ...
            resp = api_client.post("/api/user/post/regenerate",
    ...
    def test_409_when_post_not_in_review_state(self, api_client, status):
    ...
    def test_rejected_post_uses_stored_reason_as_guidance(self, api_client):
        with patch("cqc_lem.api.main.get_session_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_user_id", return_value=_USER), \
    ...
    def test_rejected_post_explicit_guidance_overrides_stored_reason(self, api_client):
        with patch("cqc_lem.api.main.get_session_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_status", return_value="rejected"), \
    ...
    def test_rejected_post_without_reason_allows_regeneration(self, api_client):
        with patch("cqc_lem.api.main.get_session_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_status", return_value="rejected"), \
    ...
    def test_401_when_no_session(self, api_client):
...
class TestRegeneratePostEndpointAllTypes:
    ...
    def test_200_for_any_post_type(self, api_client, post_type):
        with patch("cqc_lem.api.main.get_session_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_user_id", return_value=_USER), \
             patch("cqc_lem.api.routers.user.get_post_status", return_value="pending"), \
