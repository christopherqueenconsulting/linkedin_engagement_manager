...
class TestConnectEscalation:
    ...
    def test_the_escalation_is_decided_before_the_evidence_is_overwritten(self):
    ...
    def test_only_a_followed_target_can_escalate(self):
    ...
    def test_the_new_connect_state_comes_back_with_the_streak(self):
        from cqc_lem.utilities.db import ConnectStatus
        _, visit = self._sql()
        assert visit == (2, ConnectStatus.NEEDS_CONNECTION.value)

    def test_a_landed_comment_stands_a_pending_escalation_back_down(self):
